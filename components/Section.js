...
{/* //////////////////////////////////////////////////////////////////// */}
      ...
      <div className="mt-10  ">
        ...
        <h3 className="text-3xl lg:text-5xl relative -top-2/4 pl-7 lg:pl-16 max-w-xs text-white font-bold ">Things to do on your trip</h3>
      ...
      <div className="mt-10 ">
        ...
        <h3 className=" text-3xl lg:text-5xl relative -top-2/4 pl-7 lg:pl-16 max-w-xs text-white font-bold ">Things to do from home</h3>
        <button className="bg-slate-50 font-mono relative -top-2/4 ml-7 lg:ml-16 mt-4 text-xs sm:text-sm p-2 lg:p-5 -tracking-wide rounded-lg py-3 active:scale-90 transition duration-150 hover:shadow-xl">Online Experiences</button>
      </div>
       ...
       {/* //////////////////////////////////////////////////////////////////// */}
        ...
        <div className="relative mb-10">
          ...
          <h2 className=" absolute top-16 left-12 sm:top-20 lg:top-2/5 sm:left-28 text-3xl max-w-[200px] sm:text-5xl  lg:text-7xl font-bold tracking-wide text-white leading-snug sm:max-w-xs">Questions about hosting?</h2>
